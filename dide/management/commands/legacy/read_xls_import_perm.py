    ...
    def handle(self, *args, **options):
        for item in args:
            ...
            while curr_row < worksheet.nrows:
                p = Permanent(registration_number=str(worksheet.cell_value(curr_row,0))[:6], 
                            ...
                            profession=Profession.objects.get(pk=str(worksheet.cell_value(curr_row,4))),
                            ...
                            order_hired=str(worksheet.cell_value(curr_row,6)))
                print(p)
                try:
