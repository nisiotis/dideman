...
serving_in_organization_api = """                                                                                                                                                                                                   
SELECT employee_id FROM (                                                                                                                                                                                                           
        SELECT dide_placement.employee_id                                                                                                                                                                                           
        FROM dide_placement                                                                                                                                                                                                         
        WHERE dide_placement.organization_id = {0} AND dide_placement.type_id IN (1, 4)  
        AND dide_placement.date_to < DATE('{1}')                                                                                                                                       
        /*AND (DATE('{1}') BETWEEN dide_placement.date_from AND dide_placement.date_to)*/                                                                                                                                           
        UNION                                                                                                                                                                                                                       
""" + permanent_post_in_organization_api +""") AS fb                                                     
WHERE fb.employee_id NOT IN (                                                                                                                                                                                                       
    SELECT employee_id FROM (                                                                                                                                                                                                       
        SELECT dide_placement.employee_id, max( date_from )                                                                                                                                                                         
        FROM dide_placement                                                                                                                                                                                                         
        WHERE dide_placement.organization_id <> {0}                                                                                                                                                                                 
        AND dide_placement.type_id IN(1, 4)                                                                                                                                                                                     
        AND dide_placement.date_to < DATE('{1}')
        /*AND  (DATE('{1}') BETWEEN dide_placement.date_from AND dide_placement.date_to)       */                                                                                                                                   
        GROUP BY employee_id                                                                                                                                                                                                        
    ) AS foobar                                                                                                                                                                                                                     
